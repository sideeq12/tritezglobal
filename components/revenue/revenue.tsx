...
<p>
    <strong>4,532
        ...
        <label htmlFor="Total Revenue">Total Orders</label>
</p>
        </My_rev>
        <My_rev>
               <div className="icom">
...
<p>
    <strong>2,532
        ...
        <label htmlFor="Total Revenue">Total Customers</label>
</p>
        </My_rev>
        <My_rev>
               <div className="icom">
...
<p>
    <strong>4,532
        ...
        <label htmlFor="Total Revenue">Total Expenses</label>
</p>
        </My_rev>
